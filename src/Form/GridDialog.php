...
class GridDialog extends FormBase {
   ...
   *   The module extension list.
   */
  public function __construct(FormBuilderInterface $form_builder, ModuleExtensionList $extension_list_module) {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Editor $editor = NULL) {
    ...
    if ($editor instanceof EditorInterface) {
      ...
      if (isset($editor_settings['plugins']['uswds_grid'])) {
        $settings['editor_settings'] = $editor_settings['plugins']['uswds_grid'];
      }
      // CKE5 support.
      elseif (isset($editor_settings['plugins']['uswds_ckeditor_integration_grid'])) {
